...
export const metadata: Metadata = {
  ...
  description:
    "Raymondo Stiven Sugiarto Frontend Developer from Semarang specializing in building elegant, high-performance web applications and digital systems.",
};
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed text-balance max-w-xl">
                  Frontend Developer & IT Support from Semarang focusing on developing
                  web applications. Enjoys the challenge of
