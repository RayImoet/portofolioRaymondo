...
export const metadata: Metadata = {
  title: "Contact | Raymondo Stiven Sugiarto",
  description:
    "Get in touch with Raymondo Stiven Sugiarto for collaboration, freelance projects, or professional opportunities.",
};
  ...
  const contactMethods = [
    {
      ...
      value: "misterray25@gmail.com",
      link: "mailto:misterray25@gmail.com",
      icon: Mail,
    },
    {
      title: "LinkedIn",
      description: "Connect professionally",
      value: "stiven-sugiarto",
      link: "https://www.linkedin.com/in/raymondo-stiven-sugiarto/",
      icon: Linkedin,
    },
    {
      title: "GitHub",
      ...
      value: "RayImoet",
      link: "https://github.com/RayImoet",
      icon: Github,
    },
    {
      title: "Instagram",
      ...
      value: "@raymuuuu",
      link: "https://www.instagram.com/raymuuuu/",
      icon: Instagram,
    },
  ];
